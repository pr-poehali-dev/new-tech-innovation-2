...
const philosophyItems = [
  ...
  {
    title: "Беспроцентная рассрочка 0-0-12",
    description: "Разбейте оплату на 12 месяцев без переплат и скрытых комиссий. Лестница мечты — уже сегодня, платите частями.",
  },
]
